# In this file we maintain settings, dependent on the environment (DEV -
# PRE-PROD- PROD). These are separated from the settings.py file so this
# "local" settings are not tracked by version control system and will not
# damage
# the configuration of the specific environment after every fetch / pull.
