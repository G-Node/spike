...
[program:celery_beat]
command={PROJECT_ROOT}/manage.py celery beat --schedule=/var/lib/celery/celerybeat-schedule --loglevel=INFO
...
command={PROJECT_ROOT}/manage.py celery worker --loglevel=INFO
directory={PROJECT_ROOT}
environment=PATH="{PYTHON_HOME}"
user=www-data
numprocs=1
