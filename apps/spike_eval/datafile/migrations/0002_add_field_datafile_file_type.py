...
class Migration(SchemaMigration):
    def forwards(self, orm):
        db.add_column('datafile_datafile', 'file_type',
            self.gf('django.db.models.fields.IntegerField')(default=0),
            keep_default=False)

    def backwards(self, orm):
        db.delete_column('datafile_datafile', 'file_type')
    ...
    models = {
        ...
        'datafile.datafile': {
            ...
            'file_type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'task_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'task_log': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
